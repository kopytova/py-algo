...
print(f'Size of first_char: {sys.getsizeof(first_char)}')
print(f'Size of last_char: {sys.getsizeof(last_char)}')
print(f'Size of counter: {sys.getsizeof(counter)}')
...
126 - ~
127 - 
Size of first_char: 28
Size of last_char: 28
Size of counter: 28
Size of item: 28
